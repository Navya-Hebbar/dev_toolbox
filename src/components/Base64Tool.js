      ...
      <div className="row g-0">
        ...
        <div className="col-md-7 p-4">
          ...
          <div className="mb-3 text-center">
            <button className="btn btn-primary px-4 me-2" onClick={handleEncode}>Encode</button>
            <button className="btn btn-danger px-4 me-2" onClick={handleDecode}>Decode</button>
          ...
          {showSuccess && (
            <div className="alert alert-success text-center d-flex flex-column align-items-center" role="alert">
              <Lottie
                ...
                loop={false}
              />
              <span className="fw-bold fs-5 text-success">Operation successful!</span>
            </div>
          )}
          {output && (
            <div>
